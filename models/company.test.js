...
describe("findAll", function () {
  ...
  test("filter by company name", async function () {
  ...
  test("filter by partial company name", async function () {
  ...
  test("empty list returned if no company found", async function () {
    let companies = await Company.findAll({ name: 'foo' });
    expect(companies).toEqual([]);
  });
  ...
  test("empty list returned if nothing found with filter by minimum employees", async function () {
    let companies = await Company.findAll({ minEmployees: 4 });
    expect(companies).toEqual([]);
  });
